                ...
                <div class="tbl">
                    <div class="tbl-row">
                        ...
                        <div class="tbl-cell hdr-logo">
                            <a href="{{ URL::to('/') }}"><img src="images/logo1.png" alt=""></a>
                        </div><!-- End Header Logo Section -->
                        <div class="tbl-cell hdr-menu">
                            <!-- Start Menu Section -->
                            <ul class="menu">
                                <li>
                                    <a id="menu-home" href="{{ URL::to('/') }}"
                                    class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'home') ? 'active' : '' }}">
                                    Home
                                    </a>
                                </li>
                                <li>
                                    <a id="menu-service" href="{{ URL::to('services') }}"
                                     class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'services') ? 'active' : '' }}">
                                     Service
                                    </a>
                                </li>
                                <li class="menu-megamenu-li">
                                    <a id="menu-doctor" href="{{ URL::to('doctors') }}" 
                                    class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'doctors') ? 'active' : '' }}">
                                    Doctors
                                    </a>
                                </li>
                                <li>
                                    <a id="menu-blog" href="{{ URL::to('blog') }}" 
                                    class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'blog') ? 'active' : '' }}">
                                    Blog</i>
                                    </a>
                                </li>

                                <li>
                                    <a id="menu-profile" href="{{ URL::to('profile') }}"
                                    class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'profile') ? 'active' : '' }}">
                                    Profile
                                    </a>
                                </li>

                                <li>
                                    <a  href="{{ URL::to('components') }}" id="menu-shortcodes" 
                                    class="mdl-button mdl-js-button mdl-js-ripple-effect {{ (\Request::route()->getName() == 'components') ? 'active' : '' }}">
                                    Components</a>
                                </li>
