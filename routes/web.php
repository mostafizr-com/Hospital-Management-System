...
Route::group([
    ...
    Route::get('dashboard/confirmed-appoinments', 'AppoinmentController@index_confirmed')->name('confirmed.appoiments');
    Route::get('dashboard/get-confirmed-appoinments', 'AppoinmentController@get_confirmed')->name('get.confimed');
    Route::get('dashboard/get-appoinments', 'AppoinmentController@get_appoinment_data')->name('get.appoiments');
